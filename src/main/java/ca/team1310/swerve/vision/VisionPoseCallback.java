...
public interface VisionPoseCallback {
   ...
   *
   * <p>This method will be called at a regular interval by the swerve drive. Note that the period
   * is not necessarily the robot period, and may be faster or slower depending on the swerve drive
   * configuration / common code.
   *
   * <p>The returned pose estimate will be set into the swerve drive's pose estimator.
   *
   ...
   * @return the current pose estimate, or null if no estimate is available. The default
